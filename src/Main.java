...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		ArrayList<String[]> trainData = p.discretize(new File("train.data"));
		...
		ArrayList<String[]> testData = Preprocess.preprocessTestData(new File("test.data"), continuousAttributes);
